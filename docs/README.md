...
config:
  ...
  -
    ...
    hero:
      name: fishcpy
      tagline: fishcpy docs
      text: 非淡泊无以明志，非宁静无以致远。
      actions:
        -
          text: 我的博客
          link: https://mengmengmao.cn
          theme: brand
        -
          text: 关于我
          link: https://me.mengmengmao.cn
          theme: brand
        -
          text: Github
  ...
  -
    ...
    image: https://blogpng.mengmengmao.cn/mengmengmao/2024/12/07/6753bbbc609ce.png
    list:
      -
        title: 文章列表
  ...
  -
    type: profile
    name: fishcpy
    description: 一个人的寂寞，一群人的狂欢🎉。   -----十年之约
